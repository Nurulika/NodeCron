...
#[derive(Debug)]
pub struct NodeCronJobProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NodeCronJobProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NodeCronJob processing");
    
    let mut processor = NodeCronJobProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NodeCronJobProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NodeCronJobProcessor::new(false);
